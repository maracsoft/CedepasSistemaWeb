...
<div >
    ...
    <div class="container" >
        ...
        <br>
        @include('ProvisionFondos.empleado.listadoDesplegableSolicitud')  
            ...
            <div class="table-responsive">                           
                ...
                <div class="row" id="divTotal" name="divTotal">       
                    <div class="col"> 
                        ...
                        @include('ProvisionFondos.desplegableDescargarArchivosRend')
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <input type="hidden" value="{{$solicitud->codSolicitud}}" name="codSolicitud" id="codSolicitud">
                                ...
                                {{-- <div class="col">
                                    <a href="{{route('rendicionGastos.rechazar',$rendicion->codRendicionGastos)}}" 
                                        class='btn btn-danger'  style="float:right;">
