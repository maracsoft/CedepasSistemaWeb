...
@section('contenido')
    ...
    <br>
    <form id="frmPuesto" name="frmPuesto" role="form" action="{{route('GestiónPuestos.update')}}" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
        @csrf 
