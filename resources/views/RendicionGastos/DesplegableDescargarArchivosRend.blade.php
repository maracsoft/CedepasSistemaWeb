          ...
          <tbody>
            ...
            <tr>
               <td style = "padding: 0.50rem">
                <a href="{{route('rendiciones.descargarCDP',$rendicion->codRendicionGastos.'*'.$i)}}">
               
                      <i id="" class="far fa-address-card nav-icon"></i>
                      {{App\RendicionGastos::getFormatoNombreCDP(
                        $rendicion->codRendicionGastos,
                        $i
                        ,$rendicion->getTerminacionNro($i)
                        ) 
                      }}
                   </a>
                </td>
