    ...
    <table class="table" style="font-size: 10pt; margin-top:10px; ">
            <thead class="thead-dark">
              <tr>
                ...
                <th width="6%" scope="col" style = "text-align: center">F. Emision</th>
                <th width="6%" scope="col" style = "text-align: center">F. Gerente</th>
                ...
                <th width="6%" scope="col" style = "text-align: center">F. Revision</th>
        ...
        @foreach($reposiciones as $itemreposicion)
            ...
            <tr>
                ...
                <td style = "padding: 0.40rem">
                  ...
                  @else
                  <a href="{{route('ReposicionGastos.Contador.ver',$itemreposicion->codReposicionGastos)}}" class="btn btn-info btn-sm" title="Ver Reposición"><i class="fas fa-eye"></i></a>
                  @endif
