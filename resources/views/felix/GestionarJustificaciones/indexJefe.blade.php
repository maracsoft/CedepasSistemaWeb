...
-->
    ...
    <table class="table table-bordered table-hover datatable">
        ...
        <tbody id="registro">
            ...
            <tr>
                <td>{{$itemjustificacion->periodoEmpleado->empleado->apellidos}}, {{$itemjustificacion->periodoEmpleado->empleado->nombres}}</td>
                ...
                <td><a href="/mostrarJustificacion/{{$itemjustificacion->codRegistroJustificacion}}" class="btn btn-info btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Adjunto</a></td>
                <td>
                    @if($itemjustificacion->estado==1)
                    <a href="/evaluarJustificacion/{{$itemjustificacion->codRegistroJustificacion}}*1" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>ACEPTAR</a>
                    <a href="/evaluarJustificacion/{{$itemjustificacion->codRegistroJustificacion}}*2" class="btn btn-danger btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>RECHAZAR</a>    
                    @else
                    <strong style="color:rgb(160, 160, 160)">{{$itemjustificacion->estado==2 ? 'ACEPTADA' : 'RECHAZADA'}}</strong>
                    @endif
