...
<script type="text/javascript"> 
    ...
    <div class="well"><H3 style="text-align: center;">EDITAR JUSTIFICACION DE FALTA</H3></div>
    <br>
    <form id="frmempresa" name="frmempresa" role="form" action="/editarJustificacion/save" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
        @csrf 
            <input type="text" class="form-control" id="codRegistroJustificacion" name="codRegistroJustificacion" placeholder="Codigo" value="{{ $justificacion->codRegistroJustificacion}}" hidden>

            <div class="form-group row">
                <label class="col-sm-1 col-form-label" style="margin-left:350px;">Descripcion:</label>
                <div class="col-sm-4">
                    <textarea class="form-control" rows="3" name="descripcion" id="descripcion" placeholder="Descripcion ..." style="margin-top: 0px; margin-bottom: 0px; height: 100px;">{{$justificacion->descripcion}}</textarea>
                </div>
            </div>
            <div class="form-group row">
