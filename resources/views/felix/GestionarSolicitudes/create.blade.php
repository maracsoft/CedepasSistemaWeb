...
<script type="text/javascript"> 
    ...
    <div class="well"><H3 style="text-align: center;">CREAR SOLICITUD DE FALTA</H3></div>
    <br>
    <form id="frmempresa" name="frmempresa" role="form" action="/crearSolicitud/save" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
        @csrf 
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <option value="{{$itemtipo->codTipoSolicitud}}">{{$itemtipo->descripcion}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
