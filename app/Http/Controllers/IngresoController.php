...
{
    //
    private $directory = 'ingreso';
    private $mensaje = null;

    public function index(){

        $models = Movimiento::where("tipoMovimiento","1")->get();
        //dd($models);
    ...
    public function validarCodigo(){
        ...
        $model = Existencia::where("codigoInterno",$request['codigo'])->first();
    ...
    public function store(Request $request){
        ...
        $mensaje = $this->mensaje."* Ingreso creado correctamente";
    ...
    public function update($id,Request $request){
        ...
        $mensaje = $this->mensaje."* Ingreso editada correctamente";
        Flash::success($mensaje);
        return redirect()->route('ingreso.index');
    }
